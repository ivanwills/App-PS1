...
sub perl {
    ...
    return $self->surround( 5 + length $version, $self->colour('black', 'black') . 'perl ' . $self->colour('cyan', 'cyan') . $version );
}
...
App::PS1::Plugin::Perl - <One-line description of module's purpose>
